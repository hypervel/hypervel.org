...
In addition to typical, form based authentication, Hypervel also provides a simple, convenient way to authenticate with OAuth providers using [Hypervel Socialite](https://github.com/hypervel/socialite). Socialite currently supports authentication via Facebook, X, LinkedIn, Google, GitHub, GitLab, Bitbucket, and Slack.

::: note
Although you can't install other community-driven adapters from [Socialite Providers](https://socialiteproviders.com/) website, you can still easily migrate those adapters on your own.
:::
